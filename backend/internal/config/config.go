...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		LLMBaseURL:       firstNonEmpty(os.Getenv("LLM_BASE_URL"), os.Getenv("OPENROUTER_BASE_URL"), "http://192.168.1.249:8080/api/v1"),
		LLMModel:         env("LLM_MODEL", "google/gemini-3.1-flash-lite-preview"),
